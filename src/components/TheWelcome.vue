...
<template>
  <div v-if="pokemonLoading">Loading Pokemon...</div>
  <div>{{ pokemonResult }}</div>
  <div v-if="pokemonError">{{ pokemonError }}</div>
  <div v-if="berriesLoading">Loading Berry...</div>
  <div>{{ berriesResult }}</div>
  <div v-if="berriesError">{{ berriesError }}</div>
  <WelcomeItem>
    <template #icon>
      <DocumentationIcon />
    </template>
